...
namespace game_framework {
	...
	bool IsOverlapped(CMovingBitmap& mb1, CMovingBitmap& mb2) {
		return (((mb1.Width() + mb2.Width())> max(mb1.location.right, mb2.location.right) - min(mb1.location.left, mb2.location.left)) &&
			((mb1.Height() + mb2.Height())> max(mb1.location.bottom, mb2.location.bottom) - min(mb1.location.top, mb2.location.top)));
	}
